This version differ from [munyabe/ToggleComment](https://github.com/munyabe/ToggleComment) , by that it comments the selection and not lines that have something selected .
